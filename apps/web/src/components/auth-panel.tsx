...
export default function AuthPanel({ mode, onModeChange }: AuthPanelProps) {
  ...
  return (
    <div className="relative flex w-full max-w-135 flex-col items-center">
      ...
      <section className="flex w-full min-h-[700px] flex-col rounded-[34px] border border-white/80 bg-white px-7 py-7 shadow-[0_24px_60px_-42px_rgba(15,23,42,0.24)] sm:min-h-[680px] sm:px-9 sm:py-8">
